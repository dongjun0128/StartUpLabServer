...
public class SHA512Hash {
	...
	public static String hashToBase64(String str, String charset) {
		try {
			byte[] encodedBytes = Base64.getEncoder().encode(encrypt(str.getBytes(charset)));
	...
	public static void main1(String args[]) {
		...
		System.out.println("Usage: SHA512Hash.getDigest('�뷀샇��臾몄옄') <text>");
		// String charset = "utf-8";
		// System.out.println("hex encoded = " + SHA512Hash.hashToHex("�뷀샇�뷀븷 臾몄옄",
		// charset));
		System.out.println("hex encoded = " + SHA512Hash.getDigest("1234!"));
		// System.out.println( "hex encoded = " + SHA512Hash.getDigest("111111") );
		// System.out.println("base64 encoded = " + SHA512Hash.hashToBase64(args[0],
		// charset));
	}
}
